...
<div class="content-wrap ">
        ...
        <div class="position-relative py-210">
            <div class="background">
                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img class="jarallax-img" loading="lazy" src="{{asset('hocvienielts/img/about-us-hero-1920x900.jpg')}}" alt=""></div>
                <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
            </div>
            <div class="container">
                <h1 class="text-white mb-0 text-center">About TIA</h1>
            </div>
        </div>
                ...
                <div class="row align-items-center gy-50">
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative shape-parent mt-80">
                            ...
                            <div class="position-absolute end-0 top-0 mt-n80" data-img-height style="--img-height: 100%; width: 230px;"><img class="rounded-4" loading="lazy" src="{{asset('hocvienielts/img/about-us-4-900x990.jpg')}}" alt=""></div>
                            <div class="me-100" data-img-height style="--img-height: 70%;" data-show="startbox"><a class="image-link" href="assets/img/about-us-3-900x630.jpg"><img class="rounded-4" loading="lazy" src="{{asset('hocvienielts/img/about-us-3-900x630.jpg')}}" alt=""></a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-50 gy-50">
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                        ...
                        <div class="process-step ">
                            ...
                            <div class="process-body pt-10 ms-30"><a class="process-title h4" href="#">The Result<svg xmlns="http://www.w3.org/2000/svg" width="42" height="11" fill="none">
                                        <path stroke="currentColor" stroke-width="2" d="M0 5.5h40m0 0L34.6 1M40 5.5 34.6 10" />
                                    </svg></a>
        ...
        <div class="py-100 position-relative">
            <div class="background">
                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img class="jarallax-img" loading="lazy" src="{{asset('hocvienielts/img/root/features-1920x450.jpg')}}" alt=""></div>
                ...
                <div class="row gy-50">
                    <div class="col-12 col-lg-4" data-show="startbox">
                        ...
                        <div class="d-flex align-items-center mb-20">
                            <div class="text-accent-3"><svg xmlns="http://www.w3.org/2000/svg" width="29" height="28" fill="none">
                    ...
                    <div class="col-12 col-lg-4" data-show="startbox" data-show-delay="100">
                        <!-- Feature-->
                        <div class="d-flex align-items-center mb-20">
                            <div class="text-accent-3"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="26" fill="none">
                    ...
                    <div class="col-12 col-lg-4" data-show="startbox" data-show-delay="200">
                        <!-- Feature-->
                        <div class="d-flex align-items-center mb-20">
                            <div class="text-accent-3"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="none">
                ...
                <div class="row align-items-center gy-90">
                    <div class="col-lg-6">
                        ...
                        <div class="swiper me-lg-70" data-swiper-slides="1" data-swiper-effect="fade" data-show="startbox">
                            <div class="swiper-container">
                                <div class="swiper-wrapper gallery-wrapper">
                                    <div class="swiper-slide">
                                        <!-- Gallery item--><a class="gallery-item rounded-4 overflow-hidden" href="assets/img/about-us-1-900x990.jpg" style="--img-height: 110%;" data-img-height><img loading="lazy" src="{{asset('hocvienielts/img/about-us-1-900x990.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <!-- Gallery item--><a class="gallery-item rounded-4 overflow-hidden" href="assets/img/about-us-2-900x990.jpg" style="--img-height: 110%;" data-img-height><img loading="lazy" src="{{asset('hocvienielts/img/about-us-2-900x990.jpg')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-button-prev swiper-button-position-1 swiper-button-white shadow"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                            ...
                            <div class="swiper-button-next swiper-button-position-1 swiper-button-white shadow"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
        ...
        <div class="pt-110 pb-120 position-relative">
            <div class="background">
                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img class="jarallax-img" loading="lazy" src="{{asset('hocvienielts/img/root/numbers-1920x600.jpg')}}" alt=""></div>
                ...
                <div class="swiper mt-90 shape-parent" data-swiper-slides="1" data-swiper-breakpoints="828:2, 1024:4" data-swiper-gap="30" data-swiper-grabcursor="true" data-show="startbox" data-show-delay="200">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <!-- Member-->
                                <div class="member "><a class="member-image rounded-4" href="#" data-img-height style="--img-height: 114%;"><img loading="lazy" src="{{asset('hocvienielts/img/team/member-8.jpg')}}" alt=""></a>
                            ...
                            <div class="swiper-slide">
                                <!-- Member-->
                                <div class="member "><a class="member-image rounded-4" href="#" data-img-height style="--img-height: 114%;"><img loading="lazy" src="{{asset('hocvienielts/img/team/member-1.jpg')}}" alt=""></a>
                                    <div class="member-body"><a class="member-title h4" href="#">Mary Carroll</a>
                                        <div class="member-subtitle font-size-15 text-gray-dark">Senior Web Developer</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <!-- Member-->
                                <div class="member "><a class="member-image rounded-4" href="#" data-img-height style="--img-height: 114%;"><img loading="lazy" src="{{asset('hocvienielts/img/team/member-2.jpg')}}" alt=""></a>
                                    <div class="member-body"><a class="member-title h4" href="#">Stuart Morton</a>
                                        <div class="member-subtitle font-size-15 text-gray-dark">Creative Director</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <!-- Member-->
                                <div class="member "><a class="member-image rounded-4" href="#" data-img-height style="--img-height: 114%;"><img loading="lazy" src="{{asset('hocvienielts/img/team/member-3.jpg')}}" alt=""></a>
                            ...
                            <div class="swiper-slide">
                                <!-- Member-->
                                <div class="member "><a class="member-image rounded-4" href="#" data-img-height style="--img-height: 114%;"><img loading="lazy" src="{{asset('hocvienielts/img/team/member-4.jpg')}}" alt=""></a>
            ...
            <div class="half-section-block container position-absolute top-50 start-0 end-0" data-prev-id=".footerPrev" data-next-id=".footerNext">
                <div class="shape-parent">
                    <div class="pt-120 pb-130 px-30 position-relative rounded-4 overflow-hidden z-index-1">
                        <div class="background">
                            <div class="background-image jarallax" data-jarallax data-speed="0.8"><img class="jarallax-img" loading="lazy" src="{{asset('hocvienielts/img/root/call-to-action-1920x1080.jpg')}}" alt=""></div>
                            <div class="background-color" style="--background-color: #481FA0; opacity: .9;"></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3 text-center">
                                ...
                                <div data-show="startbox" data-show-delay="200">
                                    <!-- Button--><a class="btn btn-accent-1" href="contact-01.html" target="_self">Contact us <svg class="ms-15 align-self-center" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 15">
