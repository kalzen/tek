                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    ...
                                    <li class="menu-item menu-item-has-children">
                                        <a title="{{$cat->name}}" aria-haspopup="true" href="{{route('product.catalogue', ['alias' => $cat->slug])}}">{{$cat->name}}<span class="caret"></span></a>
                        ...
                        <div id="departments-menu" class="dropdown departments-menu">
                            ...
                            @foreach ($shared_categories as $cat)
                                <li class="menu-item menu-item-type-custom animate-dropdown">
                                    <a title="{{$cat->name}}" href="{{route('product.catalogue', ['alias' => $cat->slug])}}">{{$cat->name}}</a>
                                </li>
                            @endforeach
                            </ul>
                        </div>
                                                ...
                                                <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                                        ...
                                                        <a href="single-product-sidebar.html">
                                                            <img src="{{asset('samfan/assets/images/products/mini-cart1.jpg')}}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">XONE Wireless Controller&nbsp;
                                                        </a>
                                                    ...
                                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                                        ...
                                                        <a href="single-product-sidebar.html">
                                                            <img src="{{asset('samfan/assets/images/products/mini-cart2.jpg')}}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">Gear Virtual Reality 3D with Bluetooth Glasses&nbsp;
                                                        </a>
                                                        <span class="quantity">1 ×
                                                            <span class="woocommerce-Price-amount amount">
