...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <a class="btn mb-2 btn-success" href="{{route('admin.menu.create')}}"><i class="icon-plus-circle2"></i> Thêm mới</a>
            @if(count($records))
            ...
            <div class="text-center p-5">
                ...
                <p class="h4 mt-2 font-weight-semibold">Chưa có menu nào</p>
            </div>
            @endif
        </div>
    </div>
