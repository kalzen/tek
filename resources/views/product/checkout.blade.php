                                                ...
                                                <div class="woocommerce-billing-fields__field-wrapper">
                                                    ...
                                                    <p id="billing_state_field"
                                                        ...
                                                        <select data-placeholder="" autocomplete="address-level1"
                                                            ...
                                                            id="billing_state" name="billing_state" tabindex="-1"
                                                            aria-hidden="true">
                                                ...
                                                <div class="woocommerce-shipping-fields__field-wrapper">
                                                    <p id="shipping_first_name_field"
                                                        ...
                                                        <input type="text" autofocus="autofocus"
                                                            autocomplete="given-name" value="" placeholder=""
                                                    ...
                                                    <p id="shipping_last_name_field"
                                                        ...
                                                        <input type="text" autocomplete="family-name" value=""
                                                            placeholder="" id="shipping_last_name"
                                                    ...
                                                    <p id="shipping_company_field" class="form-row form-row-wide">
                                                        ...
                                                        <input type="text" autocomplete="organization" value=""
                                                            placeholder="" id="shipping_company" name="shipping_company"
                                                            class="input-text ">
                                                    </p>
                                                    ...
                                                    <p id="shipping_city_field"
                                                        ...
                                                        <input type="text" autocomplete="address-level2" value=""
                                                            placeholder="" id="shipping_city" name="shipping_city"
                                                            class="input-text ">
                                                    </p>
                                                    <p id="shipping_state_field"
                                                        ...
                                                        <select data-placeholder="" autocomplete="address-level1"
                                                            class="state_select select2-hidden-accessible"
                                                            id="shipping_state" name="shipping_state" tabindex="-1"
                                                            aria-hidden="true">
                                                            <option value="">Select an option…</option>
                                                            <option value="AP">Andhra Pradesh</option>
                                                            <option value="AR">Arunachal Pradesh</option>
                                                    ...
                                                    <p data-priority="90" id="shipping_postcode_field"
                                                        ...
                                                        <input type="text" autocomplete="postal-code" value=""
                                                    ...
                                                    <tr class="cart_item">
                                                        ...
                                                        <td class="product-total">
                                                            <span class="woocommerce-Price-amount amount">
                                                                <span
                                                                    class="woocommerce-Price-currencySymbol">₫</span>{{ number_format($item['price'] * $item['quantity']) }}
                                                            </span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            ...
                                            <tfoot>
                                                <tr class="cart-subtotal">
                                                    ...
                                                    <td>
                                                        <span class="woocommerce-Price-amount amount">
                                                            <span
                                                                class="woocommerce-Price-currencySymbol">₫</span>{{ number_format($total_price) }}
                                                        </span>
                                                    </td>
                                                </tr>
